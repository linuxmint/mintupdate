...
class MintUpdate():
    ...
    def __init__(self):
        ...
        try:
            ...
            selectLevel1Item = Gtk.ImageMenuItem()
            selectLevel1Item.set_image(Gtk.Image.new_from_icon_name("mintupdate-level1", Gtk.IconSize.MENU))
            selectLevel1Item.set_label(_("Level 1 updates"))
            ...
            selectLevel2Item = Gtk.ImageMenuItem()
            selectLevel2Item.set_image(Gtk.Image.new_from_icon_name("mintupdate-level2", Gtk.IconSize.MENU))
            selectLevel2Item.set_label(_("Level 2 updates"))
            ...
            selectLevel3Item = Gtk.ImageMenuItem()
            selectLevel3Item.set_image(Gtk.Image.new_from_icon_name("mintupdate-level3", Gtk.IconSize.MENU))
            selectLevel3Item.set_label(_("Level 3 updates"))
            ...
            selectLevel4Item = Gtk.ImageMenuItem()
            selectLevel4Item.set_image(Gtk.Image.new_from_icon_name("mintupdate-level4", Gtk.IconSize.MENU))
            selectLevel4Item.set_label(_("Level 4 updates"))
