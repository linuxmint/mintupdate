...
class MintUpdate():
    ...
    def __init__(self):
        ...
        try:
            ...
            clearItem = Gtk.MenuItem.new_with_label(_("Clear"))
            ...
            selectAllItem = Gtk.MenuItem.new_with_label(_("All updates"))
            ...
            selectSecurityItem = Gtk.MenuItem.new_with_label(_("Security updates"))
            ...
            selectKernelItem = Gtk.MenuItem.new_with_label(_("Kernel updates"))
    ...
    def treeview_right_clicked(self, widget, event):
        if event.button == 3:
            ...
            if (iter != None):
                ...
                menu.append(menuItem)
                menuItem = Gtk.MenuItem.new_with_mnemonic(_("Ignore only this update for this package"))
